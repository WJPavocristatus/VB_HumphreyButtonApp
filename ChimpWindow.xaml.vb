...
'            ChimpStimGrid.Background = Brushes.Black
...
'                StimAWatch.Start()
'                Me.ChimpStimGrid.Background = Brushes.White
'            Case 1
'                ActiveStimWatch.Start()
'                StimBWatch.Start()
'                Me.ChimpStimGrid.Background = Brushes.Red
'        End Select
'    End Sub
...
'                                  StimAWatch.Stop()
'                                  StimBWatch.Stop()
'                                  Me.ChimpStimGrid.Background = Brushes.Black
'                                  'RecordData()
'                              End If
'                          End Sub)
'    End Sub
